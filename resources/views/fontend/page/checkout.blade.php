                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="checkout__order">
                            ...
                            <div class="checkout__order__subtotal">
                                <p>Giảm {{$event->percent}}%<span class="float-right">{{number_format($total*($event->percent/100))}} vnđ<span></p>
                            </div>
                            <?php
                            $total = $total - $total * ($event->percent / 100);
                            ?>
                            @endif
                            <div class="checkout__order__total">@lang('lang.total') <span>{{number_format($total)}}vnđ</span></div>
