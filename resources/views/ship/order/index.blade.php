...
<div class="content">
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
            <a href="{{route('ship.order.list',3)}}" class="card card-stats text-decoration-none">
                <div class="card-body {{isset($status)&&($status==3)?'list-order-active':''}}">
                    <div class="row">
                        <div class="col-12 col-md-12">
                            <div class="numbers text-left">
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
            <a href="{{route('ship.order.list',-1)}}" class="card card-stats text-decoration-none">
                <div class="card-body {{isset($status)&&(($status==-1) || ($status==-5))?'list-order-active':''}}">
                    <div class="row">
                        <div class="col-12 col-md-12">
                            <div class="numbers text-left">
